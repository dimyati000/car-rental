...
<script>
	function printReport() {
		...
		var link = "<?= site_url() ?>" + "/Laporan/cetak_laporan_pelayanan?jenis_layanan=" + jenis_layanan + "&tanggal_awal=" + tgl_awal + "&tanggal_akhir=" + tgl_akhir;
	...
	function showPelayanan() {
			...
			var tgl_akhir = $('#tgl_akhir').val();
			var jenis_layanan = $('#jenis_layanan').val();
			var link = "<?= site_url() ?>" + "/Laporan/laporan_pelayanan?jenis_layanan=" + jenis_layanan + "&tanggal_awal=" + tgl_awal + "&tanggal_akhir=" + tgl_akhir;
